...
namespace YieldMap.Transitive.Tools {
    public interface IBondsPacker {
        Dictionary<string, object> PackInstrumentDescription(BondDescriptionView i);
    }

    public class BondsPacker : IBondsPacker {
        public Dictionary<string, object> PackInstrumentDescription(BondDescriptionView i) {
            ...
            res["Coupon"] = i.Coupon;
            res["BondStructure"] = i.BondStructure;
            return res;
        }
    }
}