...
namespace YieldMap.Transitive.Native.Entities {
    public class NOrdinaryFrn : INotIdentifyable {
        ...
        [DbField(17)] // ReSharper disable once InconsistentNaming
        public long? id_Currency { get; set; }
        
        [DbField(18)] // ReSharper disable InconsistentNaming
        public double? FrnCap { get; set; }

        [DbField(18)] // ReSharper disable InconsistentNaming
        public double? FrnFloor { get; set; }
