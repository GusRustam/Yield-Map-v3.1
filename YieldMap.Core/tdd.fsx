...
//
//        let res = builder {
//            printfn "Hi from builder"
//        }
//
//module Vova = 
//    type State<'a, 's> = State of ((ContainerBuilder * IContainer) -> 'a * (ContainerBuilder * IContainer))
//
...
//    //------------------------------
//    let DoSomething cb = 
//        printfn "DoSomething. Counter=%A " cb
//        cb
//
//    let FinalResult cb = 
//        printfn "FinalResult. Counter=%A" cb
//        cb
//            
...
//    }
//
//    let start (State f) = f (ContainerBuilder(), null)
//
//    // new functions
