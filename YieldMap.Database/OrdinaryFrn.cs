...
namespace YieldMap.Database
{
    ...
    public partial class OrdinaryFrn
    {
        ...
        public Nullable<double> FrnCap { get; set; }
        public Nullable<double> FrnFloor { get; set; }
        public Nullable<double> Margin { get; set; }
        public string IndexName { get; set; }
        public string IndexRic { get; set; }
    	public OrdinaryFrn ToPocoSimple() {
    	    return new OrdinaryFrn {
