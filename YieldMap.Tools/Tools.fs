...
//                    let op =
//                        synchronized (fun () ->
//                            // If we already handled result (and called continuation) then ignore. Otherwise, if the computation succeeds, then
//                            // run the continuation and mark state as handled. Only throw if all workflows failed.
...
//                                    else ignore 
//                        ) 
//                    // Actually run the continuation (this shouldn't be done in the lock)
//                    op () 
//
...
//                            match msg with 
//                            | Choice2Of2 (repl:AsyncReplyChannel<_>) -> repl.Reply(value)
